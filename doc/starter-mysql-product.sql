-- MySQL dump 10.13  Distrib 5.5.61, for osx10.12 (x86_64)
--
-- Host: 127.0.0.1    Database: ProductManager
-- ------------------------------------------------------
...
CREATE TABLE `core_category` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `core_category_id_uindex` (`id`)
...
CREATE TABLE `core_notice` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `core_notice_id_uindex` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_order` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `core_order_id_uindex` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(75) NOT NULL DEFAULT '',
  `in_price` varchar(10) NOT NULL DEFAULT '0',
  `out_price` varchar(10) NOT NULL DEFAULT '0',
  `count` varchar(20) NOT NULL DEFAULT '0',
  `subsidy` varchar(10) NOT NULL DEFAULT '0',
  `cate` int(11) NOT NULL,
  `image` int(11) NOT NULL,
  `unit` varchar(10) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  UNIQUE KEY `core_product_id_uindex` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-09-30 16:03:19
